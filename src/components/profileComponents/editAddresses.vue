...
<template>
  <div class="md:mt-16 sm:mt-8 overflow-scroll md:max-h-[auto] sm:max-h-[450px]">
    <form class="flex flex-col">
      <div class="flex flex-col gap-2 justify-center md:items-start sm:items-center">
        <input
          placeholder="Фамилия *"
      ...
      <div class="flex flex-wrap md:flex-nowrap md:space-x-4 sm:space-x-0 md:gap-0 sm:gap-3 mb-8 sm:items-center sm:justify-center">
        <input
      ...
      <div class="flex flex-wrap md:flex-nowrap md:space-x-4 sm:space-x-0 md:gap-0 sm:gap-3 mb-8 sm:justify-center">
        <input

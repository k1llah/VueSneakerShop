...
<template>
	<div class="flex flex-col gap-2 cursor-pointer min-w-[260px] md:max-w-[320px] sm:max-w-[320px]">
		<img v-if="props.coverImage" :src="'http://localhost:1337' + $props.coverImage" class="w-full h-[100px] sm:max-w-[400px] md:max-w-none border-2 min-h-[160px] object-cover" alt="cover post image"> 

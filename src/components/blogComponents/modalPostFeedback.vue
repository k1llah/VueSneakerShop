    ...
    <form class="mx-auto mb-0 mt-8 max-w-md space-y-4">
      <div class="flex flex-col gap-1">
        ...
        <transition name="fade">
          <p v-if="warningEmail" class="text-red-500 text-xs p-[1px] ml-2" :class="{ 'fade-in': warningEmail }">
            {{ warningEmail }}
          </p>
        </transition>
      </div>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="relative">
          ...
          <p class="text-red-500 text-xs p-[1px] ml-2" :class="{ 'fade-in': warningName }">{{ warningName }}</p>
      ...
      <div class="flex flex-col gap-1">
        ...
        <div class="relative">
          ...
          <p class="text-red-500 text-xs p-[1px] ml-2" :class="{ 'fade-in': warningIdea }">{{ warningIdea }}</p>
        ...
        <p class="text-red-500 text-xs p-[3px]" :class="{ 'fade-in': warningAll }" >{{ warningAll }}</p>

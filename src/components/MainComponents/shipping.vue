...
<template>
  <div class="flex flex-wrap justify-center gap-10 p-10 border-t-2 border-slate-500 pb-24">
    ...
    <div class="relative hover:scale-[1.05] transition-all 1.3s">
      ...
      <div class="md:w-[350px] md:h-[150px] sm:w-[320px] sm:h-[370px] flex justify-center bg-cover bg-center top-[-300px] items-end" style="background-image: url('/feedBack2.avif');"  >

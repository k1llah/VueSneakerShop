...
так же надо сделать так чтобы при регистрации нельзя было использовать символы в имени и исправить момент что когда чищу данные из локал сторэдж пользователь после перовой перезагрузки остается в профиле
так же нужно сделать проверку на существование аккаунта, то есть выводить сообщение пользователю что такой аккаунт уже существует если уникальность чего либо нарушена 